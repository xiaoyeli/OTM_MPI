...
\begin{tabular} { | l | p{25mm} | p{80mm}| } 
	...
	Dynemo \cite{    & Mesoscopic Model & Network distribution through master-slave parallelization \\ \hline
	...
	OTM     & Macroscopic Model & Network domain decomposition of network with highway, arterial and local roads. Simulated a network of more than 60,000 nodes and 100,000 links on modern parallel computers  \\ \hline
\end{tabular}
